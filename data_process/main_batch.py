...
parser.add_argument("--cache_dir", required=True, help="缓存: npy 缓存存放目录 (极其重要，必须独立)")
args, _ = parser.parse_known_args()

# 将传入的参数赋给原代码的变量名，确保必须以 "/" 结尾
...
dataset_save_path = args.cache_dir if args.cache_dir.endswith('/') else args.cache_dir + '/'
